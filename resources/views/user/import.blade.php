        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <a href="{{ url('/user/download_template') }}" class="btn btn-info btn-sm" download><i class="fa fa-file-excel"></i>Download Template
                    </a>
                </div>
                <div class="form-group">
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.status) {
                            ...
                            tableUser.ajax.reload();  // reload DataTable after successful import
                        } else {
                            $('.error-text').text('');
